...
#define zXMPFiles_ComputeChecksum_1(checksum, XMPPacketSize, XMPPacketOffset, SetClientString) \
	WXMPFiles_ComputeChecksum_1 ( this->xmpFilesRef, checksum, XMPPacketSize, XMPPacketOffset, SetClientString, &wResult )
...
extern void WXMPFiles_ComputeChecksum_1(XMPFilesRef         xmpObjRef,
                                        void *              checksum,
