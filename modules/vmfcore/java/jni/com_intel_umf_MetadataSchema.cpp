...
/*
 * Class:     com_intel_umf_MetadataSchema
 * Method:    n_MetadataSchema
 * Signature: (Ljava/lang/String;Ljava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSchema_n_1MetadataSchema(JNIEnv *env, jclass, jstring name, jstring author);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataSchema_n_1getName(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataSchema_n_1getAuthor(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSchema_n_1size(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSchema_n_1add(JNIEnv *env, jclass, jlong self, jlong mdDescAddr);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSchema_n_1findMetadataDesc(JNIEnv *env, jclass, jlong self, jstring mdName);
 ...
 * Signature: (J)[J
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_MetadataSchema_n_1getAll(JNIEnv *env, jclass, jlong self);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataSchema_n_1getStdSchemaName(JNIEnv *env, jclass, jint kind);
 ...
 * Signature: (JI)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSchema_n_1getStdSchema(JNIEnv *env, jclass, jint kind);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSchema_n_1delete(JNIEnv *env, jclass, jlong self);
