...
JNIEXPORT void JNICALL Java_com_intel_umf_Compressor_n_1delete(JNIEnv *env, jclass, jlong self);
JNIEXPORT void JNICALL Java_com_intel_umf_Compressor_n_1delete(JNIEnv *env, jclass, jlong self)
{
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1create(JNIEnv *env, jclass, jstring id);
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1create(JNIEnv *env, jclass, jstring id)
{
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_Compressor_n_1getId(JNIEnv *env, jclass, jlong self);
JNIEXPORT jstring JNICALL Java_com_intel_umf_Compressor_n_1getId(JNIEnv *env, jclass, jlong self)
{
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1createNewInstance(JNIEnv *env, jclass, jlong self);
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1createNewInstance(JNIEnv *env, jclass, jlong self)
{
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1compress(JNIEnv *env, jclass, jlong self, jstring str);
JNIEXPORT jlong JNICALL Java_com_intel_umf_Compressor_n_1compress(JNIEnv *env, jclass, jlong self, jstring str)
{
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_Compressor_n_1decompress(JNIEnv *env, jclass, jlong self, jlong variantAddr);
JNIEXPORT jstring JNICALL Java_com_intel_umf_Compressor_n_1decompress(JNIEnv *env, jclass, jlong self, jlong variantAddr)
{
