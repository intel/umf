...
JNIEXPORT jlong JNICALL Java_com_intel_umf_EncryptorDefault_n_1encrypt(JNIEnv *env, jclass, jlong self, jstring str);
JNIEXPORT jlong JNICALL Java_com_intel_umf_EncryptorDefault_n_1encrypt(JNIEnv *env, jclass, jlong self, jstring str)
{
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_EncryptorDefault_n_1decrypt(JNIEnv *env, jclass, jlong self, jlong variantAddr);
JNIEXPORT jstring JNICALL Java_com_intel_umf_EncryptorDefault_n_1decrypt(JNIEnv *env, jclass, jlong self, jlong variantAddr)
{
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_EncryptorDefault_n_1getHint(JNIEnv *env, jclass, jlong self);
JNIEXPORT jstring JNICALL Java_com_intel_umf_EncryptorDefault_n_1getHint(JNIEnv *env, jclass, jlong self)
{
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_EncryptorDefault_n_1EncryptorDefault(JNIEnv *env, jclass, jstring passphrase);
JNIEXPORT jlong JNICALL Java_com_intel_umf_EncryptorDefault_n_1EncryptorDefault(JNIEnv *env, jclass, jstring passphrase)
{
