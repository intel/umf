...
extern "C" {
    ...
    //long n_FormatEncrypted(long format, long encryptor)
    JNIEXPORT jlong JNICALL Java_com_intel_vmf_FormatEncrypted_n_1FormatEncrypted(JNIEnv *env, jclass, jlong format, jlong encryptor);
    JNIEXPORT jlong JNICALL Java_com_intel_vmf_FormatEncrypted_n_1FormatEncrypted(JNIEnv *env, jclass, jlong format, jlong encryptor)
    {
        static const char method_name[] = "FormatEncrypted::FormatEncrypted";

        try
        {
            std::shared_ptr<Format>* formatObj = (std::shared_ptr<Format>*) format;
            std::shared_ptr<Encryptor>* encryptorObj = (std::shared_ptr<Encryptor>*) encryptor;
            std::shared_ptr<FormatEncrypted>* obj = new std::shared_ptr<FormatEncrypted>(new FormatEncrypted(*formatObj, *encryptorObj));
            return (jlong)obj;
        }
    ...
    /*
    * Class:     com_intel_vmf_FormatEncrypted
    * Method:    n_store
    * Signature: (long nativeObj, long set, long[] schemas, long[] segments, long[] stats, String[] attribNames, String[] attribVals);
    */
    JNIEXPORT jstring JNICALL Java_com_intel_vmf_FormatEncrypted_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals);
    JNIEXPORT jstring JNICALL Java_com_intel_vmf_FormatEncrypted_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals)
    {
        static const char method_name[] = "FormatEncrypted::n_1store";
    ...
    */
    JNIEXPORT jlongArray JNICALL Java_com_intel_vmf_FormatEncrypted_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals);
    JNIEXPORT jlongArray JNICALL Java_com_intel_vmf_FormatEncrypted_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals)
    {
        static const char method_name[] = "FormatEncrypted::n_1parse";
        try
        {
            std::shared_ptr<FormatEncrypted>* obj = (std::shared_ptr<FormatEncrypted>*) self;
            if (!obj || !*obj) VMF_EXCEPTION(NullPointerException, "'self' is null");
