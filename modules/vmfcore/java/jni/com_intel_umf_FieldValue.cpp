...
/*
 * Class:     com_intel_umf_FieldValue
 * Method:    n_FieldValue
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FieldValue_n_1FieldValue__(JNIEnv *env, jclass);
 ...
 * Signature: (J)J
 */
/*JNIEXPORT jlong JNICALL Java_com_intel_umf_FieldValue_n_1FieldValue__J(JNIEnv *env, jclass, jlong otherAddr);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FieldValue_n_1FieldValue__Ljava_lang_String_2J(JNIEnv *env, jclass, jstring name, jlong variantAddr);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_FieldValue_n_1getName(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_FieldValue_n_1setTo(JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_FieldValue_n_1setTo (JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr)
{
    ...
    try 
    {
        ...
        if ((other == NULL) || (other->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Other field value is null pointer.");
 ...
 * Signature: (JJ)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_FieldValue_n_1equals(JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr);
...
* Signature: (J)I
*/
JNIEXPORT jint JNICALL Java_com_intel_umf_FieldValue_n_1getType(JNIEnv *env, jclass, jlong self);
...
* Signature: (J)Z
*/
JNIEXPORT jboolean JNICALL Java_com_intel_umf_FieldValue_n_1isEmpty(JNIEnv *env, jclass, jlong self);
...
* Signature: (J)Ljava/lang/String;
*/
JNIEXPORT jstring JNICALL Java_com_intel_umf_FieldValue_n_1getTypeName(JNIEnv *env, jclass, jlong self);
...
* Signature: (JI)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_FieldValue_n_1convertTo(JNIEnv *env, jclass, jlong self, jint type);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_FieldValue_n_1delete(JNIEnv *env, jclass, jlong self);
