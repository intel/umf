...
/*
 * Class:     com_intel_umf_FormatXML
 * Method:    n_FormatXML
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatXML_n_1FormatXML(JNIEnv *env, jclass);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatXML_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals);
...
*/
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatXML_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_FormatXML_n_1delete(JNIEnv *env, jclass, jlong self);
