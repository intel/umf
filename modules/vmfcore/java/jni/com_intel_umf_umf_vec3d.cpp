...
/*
 * Class:     com_intel_umf_umf_vec3d
 * Method:    n_umf_vec3d
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_umf_1vec3d_n_1umf_1vec3d__(JNIEnv *env, jclass);
 ...
 * Signature: (DDD)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_umf_1vec3d_n_1umf_1vec3d__DDD(JNIEnv *env, jclass, jdouble x, jdouble y, jdouble z);
 ...
 * Signature: (JJ)V
 */
/*JNIEXPORT void JNICALL Java_com_intel_umf_umf_1vec3d_n_1setTo(JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_umf_1vec3d_n_1setTo (JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr)
{
    ...
    try
    {
        ...
        if ((other == NULL) || (other->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Other vec3d is null pointer.");
...
* Signature: (J)D
*/
JNIEXPORT jdouble JNICALL Java_com_intel_umf_umf_1vec3d_n_1getX(JNIEnv *env, jclass, jlong self);
...
* Signature: (J)D
*/
JNIEXPORT jdouble JNICALL Java_com_intel_umf_umf_1vec3d_n_1getY(JNIEnv *env, jclass, jlong self);
...
* Signature: (J)D
*/
JNIEXPORT jdouble JNICALL Java_com_intel_umf_umf_1vec3d_n_1getZ(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_umf_1vec3d_n_1delete(JNIEnv *env, jclass, jlong self);
