...
/*
 * Class:     com_intel_umf_Reference
 * Method:    n_Reference
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_Reference_n_1Reference__(JNIEnv *env, jclass);
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_Reference_n_1Reference__JJ (JNIEnv *env, jclass, jlong refDescAddr, jlong mdAddr)
{
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_Reference_n_1getMetadata (JNIEnv *env, jclass, jlong self)
{
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Reference_n_1setMetadata (JNIEnv *env, jclass, jlong self, jlong mdAddr)
{
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_Reference_n_1getReferenceDescription (JNIEnv *env, jclass, jlong self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Reference_n_1delete (JNIEnv *env, jclass, jlong self)
{
