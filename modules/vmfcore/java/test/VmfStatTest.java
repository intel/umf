...
public class VmfStatTest {
    ...
    @Before
    public void setUp() {
        sf1 = new StatField("name", "schemaName", "metadataName", "fieldName", StatField.BuiltinOp_Min);
        sf2 = new StatField("name", "schemaName", "metadataName", "fieldName", StatField.BuiltinOp_Min);
