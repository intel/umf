...
public class umf_vec4d
{
    ...
    public umf_vec4d (double x, double y, double z, double w)
    {
        this (n_umf_vec4d (x, y, z, w));
    }
    
   /*
    * public void setTo (umf_vec4d other)
    *{
   ...
   */
    ...
    private native static long n_umf_vec4d ();
    private native static long n_umf_vec4d (double x, double y, double z, double w);
