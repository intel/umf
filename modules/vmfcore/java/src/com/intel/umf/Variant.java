...
import com.intel.umf.Umf;
 ...
 public class Variant
 {
    ...
    public Variant (umf_vec2d vec2d)
    {
        this (n_Variant ());
        n_setToVec2d (nativeObj, vec2d.nativeObj);
    }
    
    public Variant (umf_vec3d vec3d)
    {
        this (n_Variant ());
        n_setToVec3d (nativeObj, vec3d.nativeObj);
    }
    
    public Variant (umf_vec4d vec4d)
    {
        this (n_Variant ());
   ...
   */
    ...
    public void setTo (umf_vec2d vec)
    {
    	n_setToVec2d (nativeObj, vec.nativeObj);
    }
    
    public void setTo (umf_vec3d vec)
    {
    	n_setToVec3d (nativeObj, vec.nativeObj);
    }
    
    public void setTo (umf_vec4d vec)
    {
