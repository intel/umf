...
void XMPMetadataSource::saveSchema(const vmf_string& schemaName, const MetadataStream& stream)
{
...
void XMPMetadataSource::saveField(const vmf_string& fieldName, const Variant& _value, const vmf_string& fieldsPath)
{
