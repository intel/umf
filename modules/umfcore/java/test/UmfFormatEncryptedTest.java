...
public class UmfFormatEncryptedTest {
    ...
    protected FormatEncrypted format;
    ...
    public void setUp() {
    	...
    	format = new FormatEncrypted(new FormatXML(), new EncryptorDefault("UmfFormatEncryptedTest"));
    }
