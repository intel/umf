...
/*
 * Class:     com_intel_umf_FieldDesc
 * Method:    n_FieldDesc
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FieldDesc_n_1FieldDesc__ (JNIEnv *env, jclass);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FieldDesc_n_1FieldDesc__Ljava_lang_String_2IZ (JNIEnv *env, jclass, jstring name, jint type, jboolean isOptional);
 ...
 * Signature: (JJ)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_FieldDesc_n_1equals (JNIEnv *env, jclass, jlong selfAddr, jlong otherAddr);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_FieldDesc_n_1getName(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_intel_umf_FieldDesc_n_1getType(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_FieldDesc_n_1isOptional(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_FieldDesc_n_1delete(JNIEnv *env, jclass, jlong self);
