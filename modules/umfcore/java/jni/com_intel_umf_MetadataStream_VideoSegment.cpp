...
/*
 * Class:     com_intel_umf_MetadataStream_VideoSegment
 * Method:    n_VideoSegment
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1VideoSegment__(JNIEnv *env, jclass);
...
*/
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1VideoSegment__Ljava_lang_String_2DJJII (JNIEnv *env, jclass, jstring title, jdouble fps, jlong startTime, jlong duration, jint width, jint height);


JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1VideoSegment__Ljava_lang_String_2DJJII (JNIEnv *env, jclass, jstring title, jdouble fps,
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getTitle (JNIEnv *env, jclass, jlong self);
 ...
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1setTitle (JNIEnv *env, jclass, jlong self, jstring title);
 ...
 * Signature: (J)D
 */
JNIEXPORT jdouble JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getFPS(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JD)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1setFPS(JNIEnv *env, jclass, jlong self, jdouble fps);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getDuration(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1setDuration(JNIEnv *env, jclass, jlong self, jlong duration);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getTime (JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JJ)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1setTime(JNIEnv *env, jclass, jlong self, jlong startTime);
...
* Signature: (J)I
*/
JNIEXPORT jint JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getWidth(JNIEnv *env, jclass, jlong self);
...
* Signature: (J)I
*/
JNIEXPORT jint JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1getHeight(JNIEnv *env, jclass, jlong self);
...
* Signature: (JII)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1setResolution(JNIEnv *env, jclass, jlong self, jint w, jint h);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataStream_00024VideoSegment_n_1delete(JNIEnv *env, jclass, jlong self);
