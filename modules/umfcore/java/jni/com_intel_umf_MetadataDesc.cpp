...
/*
 * Class:     com_intel_umf_MetadataDesc
 * Method:    n_MetadataDesc
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1MetadataDesc__(JNIEnv *env, jclass);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1MetadataDesc__Ljava_lang_String_2J(JNIEnv *env, jclass, jstring mdName, jlong type);
 ...
 * Signature: (Ljava/lang/String;[J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1MetadataDesc__Ljava_lang_String_2_3J(JNIEnv *env, jclass, jstring mdName, jlongArray fieldDescs);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1MetadataDesc__Ljava_lang_String_2_3J_3J(JNIEnv *env, jclass, jstring mdName, jlongArray fieldDescs, jlongArray refDescs);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataDesc_n_1getMetadataName(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_MetadataDesc_n_1getSchemaName(JNIEnv *env, jclass, jlong self);
 ...
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_MetadataDesc_n_1getFields(JNIEnv *env, jclass, jlong self);
 ...
 */
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_MetadataDesc_n_1getAllReferenceDescs(JNIEnv *env, jclass, jlong self);
 ...
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataDesc_n_1declareCustomReference(JNIEnv *env, jclass, jlong self, jstring refName, jboolean isUnique);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1getReferenceDesc(JNIEnv *env, jclass, jlong self, jstring refName);
...
* Signature: (JLjava/lang/String;)J
*/
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataDesc_n_1getFieldDesc(JNIEnv *env, jclass, jlong self, jstring fieldName);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataDesc_n_1delete(JNIEnv *env, jclass, jlong self);
