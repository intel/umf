...
/*
 * Class:     com_intel_umf_MetadataSet
 * Method:    n_MetadataSet
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1MetadataSet__(JNIEnv *env, jclass);
...
* Signature: (JJ)J
*/
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1getElement(JNIEnv *env, jclass, jlong self, jlong number);
 ...
 * Signature: (JJ)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByFrameIndex(JNIEnv *env, jclass, jlong self, jlong id);
 ...
 * Signature: (JJJ)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByTime(JNIEnv *env, jclass, jlong self, jlong startTime, jlong endTime);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryBySchema(JNIEnv *env, jclass, jlong self, jstring schemaName);
 ...
 * Signature: (JLjava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByName(JNIEnv *env, jclass, jlong self, jstring mdName);
 ...
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByNameAndValue(JNIEnv *env, jclass, jlong self, jstring mdName, jlong fieldValueAddr);
 ...
 * Signature: (JLjava/lang/String;[J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByNameAndFields(JNIEnv *env, jclass, jlong self, jstring mdName, jlongArray fieldValues);
 ...
 * Signature: (JLjava/lang/String;)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByReference__JLjava_lang_String_2(JNIEnv *env, jclass, jlong self, jstring refName);
 ...
 * Signature: (JLjava/lang/String;J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByReference__JLjava_lang_String_2J(JNIEnv *env, jclass, jlong self, jstring refName, jlong valueAddr);
 ...
 * Signature: (JLjava/lang/String;[J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1queryByReference__JLjava_lang_String_2_3J(JNIEnv *env, jclass, jlong self, jstring refName, jlongArray fieldValues);
 ...
 * Signature: (JJJJJ)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1shift(JNIEnv *env, jclass, jlong self, jlong dstFrameIndex, jlong srcFrameIndex, jlong numOfFrames, jlong setFailureAddr);
 ...
 * Signature: (J)J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_MetadataSet_n_1getSize(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSet_n_1delete(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSet_n_1clear(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSet_n_1push_1back(JNIEnv *env, jclass, jlong self, jlong metadataAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_MetadataSet_n_1erase(JNIEnv *env, jclass, jlong self, jlong idx);
