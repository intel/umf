...
extern "C" {
    ...
    JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatEncrypted_n_1FormatEncrypted(JNIEnv *env, jclass, jlong format, jlong encryptor);
    JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatEncrypted_n_1FormatEncrypted(JNIEnv *env, jclass, jlong format, jlong encryptor)
    {
    ...
    /*
    * Class:     com_intel_umf_FormatEncrypted
    * Method:    n_store
    * Signature: (long nativeObj, long set, long[] schemas, long[] segments, long[] stats, String[] attribNames, String[] attribVals);
    */
    JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatEncrypted_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals);
    JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatEncrypted_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals)
    {
    ...
    */
    JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatEncrypted_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals);
    JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatEncrypted_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals)
    {
