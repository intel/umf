...
/*
* Class:     com_intel_umf_StatField
* Method:    n_delete
* Signature: (J)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_StatField_n_1delete(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_StatField_n_1StatField(JNIEnv *env, jclass,
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_StatField_n_1getName(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_StatField_n_1getSchemaName(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_StatField_n_1getMetadataName(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_StatField_n_1getFieldName(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_StatField_n_1getOpName(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jlong JNICALL Java_com_intel_umf_StatField_n_1getValue(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT jboolean JNICALL Java_com_intel_umf_StatField_n_1equals(JNIEnv *env, jclass, jlong self, jlong other);
