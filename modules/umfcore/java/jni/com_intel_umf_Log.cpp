...
/*
* Class:     com_intel_umf_Log
* Method:    n_log
* Signature: (ILjava/lang/String;Ljava/lang/String;Ljava/lang/String;I)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Log_n_1log(JNIEnv *env, jclass, jint level, jstring msg, jstring func, jstring file, jint line);
...
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Log_n_1logToFile(JNIEnv *env, jclass, jstring file);
 ...
 * Signature: ()V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Log_n_1logToConsole(JNIEnv *env, jclass);
 ...
 * Signature: (I)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Log_n_1setVerbosityLevel(JNIEnv *env, jclass, jint level);
 ...
 * Signature: ()I
 */
JNIEXPORT jint JNICALL Java_com_intel_umf_Log_n_1getVerbosityLevel(JNIEnv *env, jclass);
