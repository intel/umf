...
/*
* Class:     com_intel_umf_Variant
* Method:    n_Variant
* Signature: ()J
*/
JNIEXPORT jlong JNICALL Java_com_intel_umf_Variant_n_1Variant(JNIEnv *env, jclass);
 ...
 * Signature: (J)J
 */
/*JNIEXPORT jlong JNICALL Java_com_intel_umf_Variant_n_1Variant__J(JNIEnv *env, jclass, jlong otherAddr);
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__JI(JNIEnv *env, jclass, jlong self, jint value);
 ...
 * Signature: (JF)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__JF(JNIEnv *env, jclass, jlong self, jfloat value);
 ...
 * Signature: (J[I)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3I(JNIEnv *env, jclass, jlong self, jintArray values);
 ...
 * Signature: (J[F)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3F(JNIEnv *env, jclass, jlong self, jfloatArray values);
 ...
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__JLjava_lang_String_2(JNIEnv *env, jclass, jlong self, jstring str);
...
* Signature: (JD)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__JD(JNIEnv *env, jclass, jlong self, jdouble value);
...
* Signature: (JJ)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__JJ(JNIEnv *env, jclass, jlong self, jlong value);
...
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3Ljava_lang_String_2(JNIEnv *env, jclass, jlong self, jobjectArray stringArray);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3Ljava_lang_String_2(JNIEnv *env, jclass, jlong self, jobjectArray stringArray)
{
    ...
    try
    {
        ...
        std::vector<umf_string> stringVector;
...
* Signature: (J[D)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3D(JNIEnv *env, jclass, jlong self, jdoubleArray values);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3D(JNIEnv *env, jclass, jlong self, jdoubleArray values)
{
    ...
    try
    {
        ...
        std::vector <umf_real> vecValues;
        jdouble* array = env->GetDoubleArrayElements(values, 0);
        jsize len = env->GetArrayLength(values);

        for (int i = 0; i < len; i++)
        {
            umf_real elem = (umf_real)array[i];
            vecValues.push_back(elem);
        }
...
* Signature: (J[J)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3J(JNIEnv *env, jclass, jlong self, jlongArray values);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3J (JNIEnv *env, jclass, jlong self, jlongArray values)
{
    ...
    try
    {
        ...
        std::vector <umf_integer> vecValues;
        jlong* cArray = env->GetLongArrayElements (values, 0);
        jsize len = env->GetArrayLength(values);

        for (int i = 0; i < len; i++)
        {
            umf_integer elem = (umf_integer)cArray[i];
            vecValues.push_back(elem);
        }
...
* Signature: (J[B)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3B(JNIEnv *env, jclass, jlong self, jbyteArray buffer);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setTo__J_3B(JNIEnv *env, jclass, jlong self, jbyteArray buffer)
{
    ...
    try
    {
        ...
        umf_rawbuffer rb(array, (size_t)len);
...
* Signature: (JJ)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec2d(JNIEnv *env, jclass, jlong self, jlong vec2dAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec2d (JNIEnv *env, jclass, jlong self, jlong vec2dAddr)
{
    ...
    {
        std::shared_ptr <Variant>* obj = (std::shared_ptr <Variant>*)self;
        std::shared_ptr <umf_vec2d>* vec2d = (std::shared_ptr <umf_vec2d>*) vec2dAddr;
...
* Signature: (JJ)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec3d(JNIEnv *env, jclass, jlong self, jlong vec3dAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec3d (JNIEnv *env, jclass, jlong self, jlong vec3dAddr)
{
    ...
    {
        std::shared_ptr <Variant>* obj = (std::shared_ptr <Variant>*)self;
        std::shared_ptr <umf_vec3d>* vec3d = (std::shared_ptr <umf_vec3d>*) vec3dAddr;

        if ((obj == NULL) || (obj->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Variant is null pointer.");

        if ((vec3d == NULL) || (vec3d->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Vec3d is null pointer.");
...
* Signature: (JJ)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec4d(JNIEnv *env, jclass, jlong self, jlong vec4dAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec4d (JNIEnv *env, jclass, jlong self, jlong vec4dAddr)
{
    ...
    {
        std::shared_ptr <Variant>* obj = (std::shared_ptr <Variant>*)self;
        std::shared_ptr <umf_vec4d>* vec4d = (std::shared_ptr <umf_vec4d>*) vec4dAddr;

        if ((obj == NULL) || (obj->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Variant is null pointer.");

        if ((vec4d == NULL) || (vec4d->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Vec4d is null pointer.");
...
* Signature: (J[J)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec2dArray(JNIEnv *env, jclass, jlong self, jlongArray vec2dArray);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec2dArray (JNIEnv *env, jclass, jlong self, jlongArray vec2dArray)
{
    ...
    try
    {
        ...
        for (int i = 0; i < len; i++)
        {
            std::shared_ptr<umf_vec2d>* p = (std::shared_ptr<umf_vec2d>*)nativeAddrs[i];
            vec.push_back(**p);
        }
...
* Signature: (J[J)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec3dArray(JNIEnv *env, jclass, jlong self, jlongArray vec3dArray);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec3dArray (JNIEnv *env, jclass, jlong self, jlongArray vec3dArray)
{
    ...
    try
    {
        ...
        for (int i = 0; i < len; i++)
        {
            std::shared_ptr<umf_vec3d>* p = (std::shared_ptr<umf_vec3d>*)nativeAddrs[i];
            vec.push_back(**p);
        }
...
* Signature: (J[J)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec4dArray(JNIEnv *env, jclass, jlong self, jlongArray vec4dArray);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1setToVec4dArray (JNIEnv *env, jclass, jlong self, jlongArray vec4dArray)
{
    ...
    try
    {
        ...
        for (int i = 0; i < len; i++)
        {
            std::shared_ptr<umf_vec4d>* p = (std::shared_ptr<umf_vec4d>*)nativeAddrs[i];
            vec.push_back(**p);
        }
...
* Signature: (JJ)V
*/
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1set(JNIEnv *env, jclass, jlong self, jlong otherAddr);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1set (JNIEnv *env, jclass, jlong self, jlong otherAddr)
{
    ...
    try
    {
        ...
        if ((other == NULL) || (other->get() == NULL))
            UMF_EXCEPTION(NullPointerException, "Other variant is null pointer.");
 ...
 * Signature: (JJ)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_Variant_n_1equals(JNIEnv *env, jclass, jlong self, jlong otherAddr);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_Variant_n_1toString(JNIEnv *env, jclass, jlong self, jboolean withType);
 ...
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1fromString(JNIEnv *env, jclass, jlong self, jint type, jstring value);
...
// fromString(string)
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1fromString2(JNIEnv *env, jclass, jlong self, jstring value);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1fromString2(JNIEnv *env, jclass, jlong self, jstring value)
{
    ...
    {
        std::shared_ptr <Variant>* obj = (std::shared_ptr <Variant>*)self;
        if (obj == NULL || *obj == NULL) UMF_EXCEPTION(NullPointerException, "Variant (self) is null pointer.");
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_intel_umf_Variant_n_1getType(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_Variant_n_1isEmpty(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (J)Ljava/lang/String;
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_Variant_n_1getTypeName(JNIEnv *env, jclass, jlong self);
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1convertTo(JNIEnv *env, jclass, jlong self, jint type);
...
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1convertTo (JNIEnv *env, jclass, jlong self, jint type)
{
    ...
    try 
    {
        ...
        if ((Type >= Variant::Type::type_empty) && (Type <= Variant::Type::type_vec4d_vector))
        {
            ...
            if ((obj == NULL) || (obj->get() == NULL))
                UMF_EXCEPTION(NullPointerException, "Field value is null pointer.");

            (*obj)->convertTo(Type);
        }
        else
            UMF_EXCEPTION(OutOfRangeException, "Non-existent type.");
    }
    catch(const std::exception &e)
    {
        throwJavaException(env, &e, method_name);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_Variant_n_1typeToString(JNIEnv *env, jclass, jint type);
 ...
 */
JNIEXPORT jint JNICALL Java_com_intel_umf_Variant_n_1typeFromString(JNIEnv *env, jclass, jstring type);
 ...
 * Signature: (II)Z
 */
JNIEXPORT jboolean JNICALL Java_com_intel_umf_Variant_n_1isConvertible(JNIEnv *env, jclass, jint srcType, jint dstType);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_Variant_n_1base64Encode(JNIEnv *env, jclass, jbyteArray buf, jint length);
...
JNIEXPORT jstring JNICALL Java_com_intel_umf_Variant_n_1base64Encode (JNIEnv *env, jclass, jbyteArray buf, jint length)
{
    ...
    try 
    {
        ...
        umf_rawbuffer rb(cArray, (size_t)length);
 ...
 */
JNIEXPORT jbyteArray JNICALL Java_com_intel_umf_Variant_n_1base64Decode(JNIEnv *env, jclass, jstring src);
...
JNIEXPORT jbyteArray JNICALL Java_com_intel_umf_Variant_n_1base64Decode (JNIEnv *env, jclass, jstring src)
{
    ...
    try 
    {
        ...
        std::string str (tmp);
        umf_rawbuffer buf = Variant::base64decode (str);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_Variant_n_1delete(JNIEnv *env, jclass, jlong self);
