...
/*
 * Class:     com_intel_umf_FormatJSON
 * Method:    n_FormatJSON
 * Signature: ()J
 */
JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatJSON_n_1FormatJSON(JNIEnv *env, jclass);
 ...
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatJSON_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals);
...
*/
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatJSON_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_intel_umf_FormatJSON_n_1delete(JNIEnv *env, jclass, jlong self);
...
JNIEXPORT void JNICALL Java_com_intel_umf_FormatJSON_n_1delete(JNIEnv *env, jclass, jlong self)
{
    ...
    {
        std::shared_ptr<FormatJSON>* obj = (std::shared_ptr<FormatJSON>*) self;
        if (!obj || !*obj) UMF_EXCEPTION(NullPointerException, "'this' is null.");
        delete obj;
    }
    catch (const std::exception &e) { throwJavaException(env, &e, method_name); }
    catch (...) { throwJavaException(env, 0, method_name); }
