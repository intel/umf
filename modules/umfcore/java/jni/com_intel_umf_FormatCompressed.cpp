...
JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatCompressed_n_1FormatCompressed(JNIEnv *env, jclass, jlong format, jstring compressorId);
JNIEXPORT jlong JNICALL Java_com_intel_umf_FormatCompressed_n_1FormatCompressed(JNIEnv *env, jclass, jlong format, jstring compressorId)
{
...
/*
 * Class:     com_intel_umf_FormatCompressed
 * Method:    n_store
 * Signature: (long nativeObj, long set, long[] schemas, long[] segments, long[] stats, String[] attribNames, String[] attribVals);
 */
JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatCompressed_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals);
JNIEXPORT jstring JNICALL Java_com_intel_umf_FormatCompressed_n_1store(JNIEnv *env, jclass, jlong self, jlong setAddr, jlongArray schemaAddrs, jlongArray segAddrs, jlongArray statsAddrs, jobjectArray attribNames, jobjectArray attribVals)
{
...
*/
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatCompressed_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals);
JNIEXPORT jlongArray JNICALL Java_com_intel_umf_FormatCompressed_n_1parse(JNIEnv *env, jclass, jlong self, jstring text, jobjectArray attribNames, jobjectArray attribVals)
{
